...
PLAIN_OBJ=sipc.o util.o udp.o log.o parser.o header.o dump.o resp.o buffer.o invite.o session.o sdp.o register.o auth.o rtp.o g711.o fft.o recpt.o play.o dtmf.o tls.o example.c
