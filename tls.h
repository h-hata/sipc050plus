...
extern size_t TLS_Send_Data(SSL *ssl,unsigned char *buf,size_t len);
extern size_t TLS_Recv_Data(SSL *ssl,unsigned char *buf,size_t len,int timeout,int *reason);
